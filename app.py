...
st.markdown("<a href='https://formspree.io/f/mwvyeypw' target='_blank' style='background:#d85a30;color:#fff;padding:0.6rem 1.4rem;border-radius:2px;text-decoration:none;font-size:0.9rem;'>Request Custom Report →</a>", unsafe_allow_html=True)
