...
# ============================================================
    ...
    <p style="color:#888; font-size:0.78rem; margin:0;">Custom reports are a Pro feature delivered manually by the AMRlytics team. Replies arrive at the email you provide in the form.</p>
    """, unsafe_allow_html=True)
